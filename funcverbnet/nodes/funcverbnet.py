...
from funcverbnet.modeling.models import FuncCategory, Verb, PhasePattern, FuncPattern, FuncVerb, Role, Sentence
from funcverbnet.classifier.sentence_classifier import FuncSentenceClassifier
from funcverbnet.utils import load_pdata

SEMANTICS_DATA_PATH = load_pdata("semantics.json")
VERB_DATA_PATH = load_pdata("verbs.json")
PATTERN_DATA_PATH = load_pdata("patterns.json")
SENTENCES_DATA_PATH = load_pdata("sentences.csv")
F_VERB_DATA_PATH = load_pdata("f_verb.json")
F_PATTERN_DATA_PATH = load_pdata("f_pattern.json")
F_CATEGORY_DATA_PATH = load_pdata("f_category.json")


class FuncVerbNet:
    def __init__(
        self,
        semantic_role_path=SEMANTICS_DATA_PATH,
        category_data_path=F_CATEGORY_DATA_PATH,
    ...
    def init_cate_list(self, category_data_path=F_CATEGORY_DATA_PATH):
    ...
    def init_role_list(self, semantic_role_path=SEMANTICS_DATA_PATH):
